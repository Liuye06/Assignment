...
namespace Assignment.AssignmentdbDataSetTableAdapters {
    ...
    public partial class StockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Stock] WHERE (([Stock_ID] = @Original_Stock_ID) AND ([Ingredie" +
                "nt] = @Original_Ingredient) AND ([Stock] = @Original_Stock))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Stock] SET [Ingredient] = @Ingredient, [Stock] = @Stock WHERE (([Stock_ID] = @Original_Stock_ID) AND ([Ingredient] = @Original_Ingredient) AND ([Stock] = @Original_Stock));
SELECT Stock_ID, Ingredient, Stock FROM Stock WHERE (Stock_ID = @Stock_ID)";
        ...
        public virtual int Fill(AssignmentdbDataSet.StockDataTable dataTable) {
        ...
        public virtual AssignmentdbDataSet.StockDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AssignmentdbDataSet.StockDataTable dataTable = new AssignmentdbDataSet.StockDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AssignmentdbDataSet.StockDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AssignmentdbDataSet dataSet) {
        ...
        public virtual int Delete(int Original_Stock_ID, string Original_Ingredient, int Original_Stock) {
        ...
        public virtual int Update(string Ingredient, int Stock, int Original_Stock_ID, string Original_Ingredient, int Original_Stock, int Stock_ID) {
            if ((Ingredient == null)) {
                throw new global::System.ArgumentNullException("Ingredient");
            }
            else {
            ...
            if ((Original_Ingredient == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_Ingredient));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Ingredient, int Stock, int Original_Stock_ID, string Original_Ingredient, int Original_Stock) {
            return this.Update(Ingredient, Stock, Original_Stock_ID, Original_Ingredient, Original_Stock, Original_Stock_ID);
        }
    }
