...
namespace Assignment {
    ...
    public partial class Database1DataSet5 : global::System.Data.DataSet {
        ...
        public partial class ReservationDataTable : global::System.Data.TypedTableBase<ReservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ReservationRow AddReservationRow(int Hall_ID, int User_ID, int R_Req_ID, string Status) {
...
namespace Assignment.Database1DataSet5TableAdapters {
    ...
    public partial class ReservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Reservation] WHERE (([Reservation_ID] = @Original_Reservation_ID) AND ([Hall_ID] = @Original_Hall_ID) AND ((@IsNull_User_ID = 1 AND [User_ID] IS NULL) OR ([User_ID] = @Original_User_ID)) AND ([R_Req_ID] = @Original_R_Req_ID) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Reservation] SET [Hall_ID] = @Hall_ID, [User_ID] = @User_ID, [R_Req_ID] = @R_Req_ID, [Status] = @Status WHERE (([Reservation_ID] = @Original_Reservation_ID) AND ([Hall_ID] = @Original_Hall_ID) AND ((@IsNull_User_ID = 1 AND [User_ID] IS NULL) OR ([User_ID] = @Original_User_ID)) AND ([R_Req_ID] = @Original_R_Req_ID) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Reservation_ID, Hall_ID, User_ID, R_Req_ID, Status FROM Reservation WHERE (Reservation_ID = @Reservation_ID)";
        ...
        public virtual int Fill(Database1DataSet5.ReservationDataTable dataTable) {
        ...
        public virtual Database1DataSet5.ReservationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet5.ReservationDataTable dataTable = new Database1DataSet5.ReservationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet5.ReservationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Reservation_ID, int Original_Hall_ID, global::System.Nullable<int> Original_User_ID, int Original_R_Req_ID, string Original_Status) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_R_Req_ID));
        ...
        public virtual int Insert(int Hall_ID, global::System.Nullable<int> User_ID, int R_Req_ID, string Status) {
        ...
        public virtual int Update(int Hall_ID, global::System.Nullable<int> User_ID, int R_Req_ID, string Status, int Original_Reservation_ID, int Original_Hall_ID, global::System.Nullable<int> Original_User_ID, int Original_R_Req_ID, string Original_Status, int Reservation_ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Hall_ID, global::System.Nullable<int> User_ID, int R_Req_ID, string Status, int Original_Reservation_ID, int Original_Hall_ID, global::System.Nullable<int> Original_User_ID, int Original_R_Req_ID, string Original_Status) {
