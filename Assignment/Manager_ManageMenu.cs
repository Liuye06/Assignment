...
namespace Assignment
{
    public partial class MainManageMenu : Form
    {
        ...
        {
            Manager_AddNewMenuItem form = new Manager_AddNewMenuItem(currentUserID);
        ...
        private void EditMenuItem(string menuItem)
        {
            ...
            Manager_EditMenuItemForm editForm = new Manager_EditMenuItemForm(menuItem, sidebarManager, currentUserID);
